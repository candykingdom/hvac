...
class OneWire
{
  ...
  public:
    //OneWire( uint8_t pin);
    OneWire( uint8_t pinArg, uint8_t bitmaskArg, uint8_t *outputRegArg, uint8_t *inputRegArg, uint8_t *modeRegArg);
    ...
    void digiWrite(uint8_t v);
    uint8_t digiRead();
    void pinModeOneWire(uint8_t mode);
